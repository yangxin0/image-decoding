...
load("@bazel_pkg_config//:pkg_config.bzl", "homebrew_shared", "pkg_config_shared")

homebrew_shared(name = "freeimage", linkopts = "-lfreeimage")
pkg_config_shared(name = "sdl2")
pkg_config_shared(name = "sdl2_image")
